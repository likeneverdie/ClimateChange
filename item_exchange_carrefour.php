...
if($ccoin >= $price){
	...
	$ccoin = $ccoin - $price;
	$stock = $stock - 1;
	$cart = $cart."Carrefour 200 dollar coupon / ";
}
else{
	echo"C幣不足，無法購買<br>";
}
...
$renew_itemStock = mysql_query("UPDATE item_test SET stock = '$stock' WHERE item_test.item = '200discount'");
